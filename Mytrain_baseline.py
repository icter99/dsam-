...
log_dir = join('log', 'baseline')
result_dir = join('train_result', 'baseline')
os.makedirs(log_dir, exist_ok=True)
os.makedirs(result_dir, exist_ok=True)

timestamp = datetime.datetime.now().strftime('%Y%m%d_%H%M%S')
log_file = join(log_dir, f'baseline_train_{timestamp}.log')
result_csv = join(result_dir, f'baseline_metrics_{timestamp}.csv')
